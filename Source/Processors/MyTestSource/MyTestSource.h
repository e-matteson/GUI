...
#ifndef MYTESTSOURCE_H_INCLUDED
#define MYTESTSOURCE_H_INCLUDED
...
class MyTestSource : public GenericProcessor
...
public:
 ...
 private:
    ...
    // bool state;
    long currentValue;
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MyTestSource);
