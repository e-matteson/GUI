...
#ifndef MYTESTSINK_H_INCLUDED
#define MYTESTSINK_H_INCLUDED
...
class MyTestSink : public GenericProcessor
...
public:
 ...
 private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MyTestSink);
